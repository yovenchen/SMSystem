...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/school_save.action" method="post" enctype="multipart/form-data" onsubmit="return checkForm();">
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
						height="26">
						<strong><STRONG>该学校已录入，不可重复录入！</STRONG>
						</strong>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="ta_01" style="WIDTH: 100%" align="center"
						...
						<button type="submit" id="userAction_save_do_submit" value="确定" class="submit">
						&#30830;&#23450;
					</button>
