								...
								<s:iterator value="pageBean.list" var="c" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/clas_edit.action?cid=<s:property value="#c.cid"/>">
					...
					<tr align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #afd1f3">
						<td colspan="4">
							...
							<s:if test="pageBean.page != 1">
								<a href="${pageContext.request.contextPath }/clas_findAll.action?page=1">首页</a> |
								<a href="${pageContext.request.contextPath }/clas_findAll.action?page=<s:property value="pageBean.page-1"/>">上一页</a> |
							</s:if>
							<s:if test="pageBean.page != pageBean.totalPage">
								<a href="${pageContext.request.contextPath }/clas_findAll.action?page=<s:property value="pageBean.page+1"/>">下一页</a> |
								<a href="${pageContext.request.contextPath }/clas_findAll.action?page=<s:property value="pageBean.totalPage"/>">尾页</a>
							</s:if>
						</td>
					</tr>
				</s:if>
